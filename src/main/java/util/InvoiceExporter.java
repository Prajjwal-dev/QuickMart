...
public class InvoiceExporter {
    ...
    public static void exportInvoiceToCsv(long salesId, String filename) {
        try (java.io.PrintWriter pw = new java.io.PrintWriter(new java.io.File(filename))) {
            ...
            showAlert("Invoice CSV exported to " + new java.io.File(filename).getAbsolutePath());
    ...
    public static void exportInvoiceToPdf(long salesId, String filename) {
        try (java.io.FileOutputStream fos = new java.io.FileOutputStream(filename)) {
            ...
            doc.close();
            showAlert("Invoice PDF exported to " + new java.io.File(filename).getAbsolutePath());
    ...
    public static void exportInvoiceToXlsx(long salesId, String filename) {
        try (org.apache.poi.xssf.usermodel.XSSFWorkbook wb = new org.apache.poi.xssf.usermodel.XSSFWorkbook()) {
            ...
            showAlert("Invoice XLSX exported to " + new java.io.File(filename).getAbsolutePath());
